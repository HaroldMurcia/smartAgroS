...
OneWire oneWire_in1(A13);
OneWire oneWire_in2(A12);
...
switch(mode){
case 0:
Serial.print("PRE:");Serial.println(Prediccion);
Serial3.print("PRE:");Serial3.println(Prediccion);
break; 
case 1:
Serial3.print("PRE:");Serial3.println(Prediccion);   
break;}  
